...
const RegistrationForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const formData = new FormData(e.currentTarget); // ✅ safer than e.target
      const response = await fetch(
        "https://formsubmit.co/ajax/letmein@posspole.com",
        {
          method: "POST",
          body: formData,
        }
      ...
      if (response.ok) {
        setSuccess(true);
        e.currentTarget.reset(); // ✅ typed safe reset
      } else {
    ...
    >
      ...
      >
        ...
        <p className="text-center text-gray-600 text-lg mb-3">
          Fill in your details below and showcase your skills. We'll get in
