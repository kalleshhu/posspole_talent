...
const postData: DataType[] = [
  ...
  { name: "Defense", imgSrc: "/images/wework/defense-logo.png" },
      ...
      <div className="bg-wework py-24">
        <div className="mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 mb-10 ">
          <div className="text-center">
            ...
            <h3 className="text-4xl sm:text-6xl font-bold text-black opacity-90 text-center my-2">
        ...
        <Slider {...settings}>
          {postData.map((items, i) => (
            <div key={i}>
              <div
                className="bg-white w-[180px] h-[180px] m-3 text-center shadow-lg rounded-2xl 
