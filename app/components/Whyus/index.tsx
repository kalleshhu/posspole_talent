...
//     <>
//       <div className="-mt-30">
//         <h4 className='text-center text-4xl lg:text-65xl font-bold mb-10'>Why Us</h4>
//       </div>
//       <div className="max-w-7xl mx-auto py-10 px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
//         {data.map((item, index) => (
//           <div
//             key={index}
//             className="bg-gradient-to-b from-white to-gray-50 shadow-lg rounded-2xl p-8 text-center border border-gray-200 hover:shadow-2xl hover:scale-105 transition-all duration-300"
//           >
//             {item.icon}
//             <h3
...
//     <>
//       <div className="-mt-30">
//         <h4 className="text-center text-5xl lg:text-65xl font-bold mb-20">
//           Why Us
//         </h4>
//       </div>
...
//           <div
//             key={index}
//             className="flex items-start gap-5 relative group transition-all duration-300 hover:bg-[#e0f8ff] p-4 rounded-xl"
//           >
